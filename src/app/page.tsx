  ...
  return (
    <>
      ...
      <div className="mt-6 flex flex-col">
        <div className="flex flex-col items-center justify-between gap-4 pb-5 border-b dark:border-zinc-700 border-zinc-200 lg:flex-row lg:items-center">
        ...
        >
          ...
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              ...
              <div className="flex flex-col gap-3 lg:block">
                ...
                <Input.Root>
                  <Input.Control defaultValue="Poletti" />
                </Input.Root>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            >
              Your photo
              <span className="mt-0.5 block text-sm font-normal text-zinc-500 dark:text-zinc-100">
